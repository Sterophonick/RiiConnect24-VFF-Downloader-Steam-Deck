...
echo $nand_region > /home/deck/.rc24/nand_region
...
echo $weather_lang > /home/deck/.rc24/weather_lang
...
echo $weather_region > /home/deck/.rc24/weather_region
...
if [ $news_lang -eq 0 ]
then
	echo 0_Japan > /home/deck/.rc24/news_lang
fi
if [ $news_lang -eq 1 ]
then
	echo 1_America > /home/deck/.rc24/news_lang
fi
if [ $news_lang -eq 2 ]
then
	echo 1_Europe > /home/deck/.rc24/news_lang
fi
if [ $news_lang -eq 3 ]
then
	echo 2_Europe > /home/deck/.rc24/news_lang
fi
if [ $news_lang -eq 4 ]
then
	echo 3_International > /home/deck/.rc24/news_lang
fi
if [ $news_lang -eq 5 ]
then
	echo 4_International > /home/deck/.rc24/news_lang
fi
if [ $news_lang -eq 6 ]
then
	echo 5_Europe > /home/deck/.rc24/news_lang
fi
if [ $news_lang -eq 7 ]
then
	echo 6_Europe > /home/deck/.rc24/news_lang
fi

clear

cp ./rc24 /home/deck/.rc24/rc24

echo "Creating RC24 systemd service"
systemctl --user stop rc24 2> /dev/null
systemctl --user disable rc24 2> /dev/null
systemctl stop rc24 2> /dev/null
systemctl disable rc24 2> /dev/null
rm -f /etc/systemd/system/rc24.service
cat > /etc/systemd/system/rc24.service <<- EOM
[Unit]
Description=RiiConnect24 Downloader for Steam Deck
...
Restart=always
User=root
ExecStart=bash /home/deck/.rc24/rc24
[Install]
WantedBy=multi-user.target
EOM
systemctl daemon-reload
systemctl start rc24
systemctl enable rc24

echo "Setup Complete"
echo " "
echo "New files will be fetched every thirty minutes."
